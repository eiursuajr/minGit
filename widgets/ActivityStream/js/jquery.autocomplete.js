...
(function($) {
  ...
  Autocomplete.prototype = {
    ...
    initialize: function() {
      ...
      $('<div id="' + this.mainContainerId + '" style="position:absolute;z-index:9999;"><div class="ektronAutocomplete"><div class="autocomplete" id="' + autocompleteElId + '" style="display:none; width:300px;"></div></div></div>').appendTo('body');
