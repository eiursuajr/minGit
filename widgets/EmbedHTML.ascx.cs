...
public partial class widgets_EmbedHTML : System.Web.UI.UserControl, IWidget
{
    ...
    {
        if (RemovFixSizeCheckBox.Checked)
        {
            TextData = ReplaceEncodeBrackets(Regex.Replace(TextTextBox.Text, "width=\"\\d+\"", "width=\"100%\"", RegexOptions.IgnoreCase | RegexOptions.Multiline));
    ...
    protected void SetOutput()
    {
        ...
        {
            TextLabel.Text = "Embed your HTML code";
        }
    }
