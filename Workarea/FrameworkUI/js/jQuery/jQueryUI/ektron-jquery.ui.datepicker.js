...
(function ($, undefined) {
    ...
    $.extend(Datepicker.prototype, {
        ...
        _generateHTML: function (inst) {
            ...
            nextText = !navigationAsDateFormat ? nextText : this.formatDate(this._daylightSavingAdjust(new Date(drawYear, drawMonth + stepMonths, 1)),
            nextText,
            culture);
        ...
        _generateMonthYearHeader: function (inst, drawMonth, drawYear, minDate, maxDate,
            ...
            var showMonthAfterYear = monthYearPattern.toLowerCase().indexOf("m") > monthYearPattern.toLowerCase().indexOf("y");
    ...
    $.each(regions, function (name, value) {
        $ektron.global.localize('datepicker', name, value);
    });
