            ...
            <radTS:PageView id="Pageview1" runat="server"> 
	            ...
	            <tr>
	                <td colspan="3">
                        ...
                        <tr>
                            <td style="width:50%">
                                <fieldset>
                                <legend id="lblAllowSelection" runat="server" title="Allow Selection">Allow Selection</legend>
                                <div>
                                    <input title="Select Only One" type="radio" name="optAllow" id="optAllowOne" value="True" checked="checked" /><label for="optAllowOne" id="lblOnlyOne" runat="server" title="Only one">Only one</label><br />
                                    <input title="Select More Than One" type="radio" name="optAllow" id="optAllowMulti" value="False" /><label for="optAllowMulti" id="lblMoreThanOne" runat="server" title="More than one">More than one</label><br />
                                    <input title="Option to make a selection required" type="checkbox" name="chkSelRequired" id="chkSelRequired" /><label for="chkSelRequired" id="lblSelectionReqd" runat="server" title="A selection is required">A selection is required</label><br />
                                    <input title="Option to make the first item an invalid selection" type="checkbox" name="chkItem1Invalid" id="chkItem1Invalid" onclick="item1InvalidChanged(this.checked);" /><label for="chkItem1Invalid" id="lblFirstNotValid" runat="server" title="First item is not a valid selection">First item is not a valid selection</label><br />
                                </div>
                                </fieldset>
	                        </td>
	                        <td>&nbsp;</td>
	                        <td>
                                ...
                                <div>
                                    <input title="Select Vertical List" type="radio" name="optDisplay" id="displayVerticalList" value="VerticalList" onclick="updateOptions();" checked="checked" /><label for="displayVerticalList" id="lblVertList" runat="server" title="Vertical List">Vertical List</label><br />
                                    <input title="Select Horizontal List" type="radio" name="optDisplay" id="displayHorizontalList" value="HorizontalList" onclick="updateOptions();" /><label for="displayHorizontalList" id="lblHorzList" runat="server" title="Horizontal List">Horizontal List</label><br />
                                    <input title="Select List Box" type="radio" name="optDisplay" id="displayListBox" value="ListBox" onclick="updateOptions();" /><label for="displayListBox" id="lblListBox" runat="server" title="List Box">List Box</label><br />
                                    <input title="Select Drop List" type="radio" name="optDisplay" id="displayDropList" value="DropList" onclick="updateOptions();" /><label for="displayDropList" id="lblDropList" runat="server" title="Drop List">Drop List</label><br />
                                </div>
                                </fieldset>
	                        </td>
                        </tr>
		        ...
		        <div class="Ektron_TopSpaceVeryVerySmall" id="design_content">
                    ...
                    <div id="ItemListDiv">
						...
						<tr>
							<th> </th> 
							<th id="lblSelected" runat="server" title="Selected">Selected</th> 
							<th id="lblDisplayText" runat="server" title="Display Text">Display Text</th> 
							<th id="lblValue" runat="server" title="Value">Value</th> 
							<th id="lblDisabled" runat="server" title="Disabled">Disabled</th>
                        </tr> 
                        </thead>
                        ...
                        <tr onclick="design_row_setCurrent(event, this)" id="option" ektdesignns_name="option" ektdesignns_caption="option" ektdesignns_nodetype="element" ektdesignns_maxoccurs="unbounded">
                            ...
                            <td>  
                                <input xml:space="default" id="selected" runat="server" title="Select Item" type="checkbox" ektdesignns_name="selected" ektdesignns_caption="selected" ektdesignns_nodetype="attribute" onclick="UpdateItemSelected(this);" /> 
                            </td>
                            <td>
                                <input value="" class="RadETextBox" id="Text" runat="server" onblur="design_validate_re(/\S+/,this,'Cannot be blank');" title="Enter Text to Display for Item here" maxlength="1500" ektdesignns_name="Text" ektdesignns_caption="Text" ektdesignns_nodetype="text" ektdesignns_validation="string-req" ektdesignns_datatype="string" ektdesignns_basetype="text" ektdesignns_schema="&lt;xs:minLength value='1'/&gt;" ektdesignns_validate="re:/\S+/" ektdesignns_invalidmsg="Cannot be blank" /> 
                            </td>
                            <td>
                                <input value="" class="RadETextBox" id="value" runat="server" onblur="validateChoicesFieldItemValue(this);" title="Enter Item Value here" maxlength="50" ektdesignns_name="value" ektdesignns_caption="value" ektdesignns_nodetype="attribute" ektdesignns_validation="choicesField" /> 
                            </td>
                            <td>
                        ...
                        <tr onclick="design_row_setCurrent(event, this)" ektdesignns_name="option" ektdesignns_caption="option" ektdesignns_nodetype="element" ektdesignns_maxoccurs="unbounded">
                            <td class="design_dynlist_first_normal" unselectable="on">
                                <a href="#" onclick="design_row_showContextMenu(event, this);return false;" menutype="button" class="design_dynlist_menu" onmouseover="design_row_onmouse(event, this)" onmouseout="design_row_onmouse(event, this)">
                                <img class="design_contextmenu_button" menutype="button" src="[skinpath]designmenu.gif" width="11" height="16" border="0" title="Select an Option to Manage Item from the Drop Down Menu" alt="Select an Option to Manage Item from the Drop Down Menu" /> 
                                </a>
                            </td>
                            <td>
                                <input xml:space="default" id="selected1" runat="server" title="Select Item" type="checkbox" ektdesignns_name="selected" ektdesignns_caption="selected" ektdesignns_nodetype="attribute" onclick="UpdateItemSelected(this);" /> 
                            </td>
                            <td>
                                <input value="" class="RadETextBox" id="Text1" runat="server" onblur="design_validate_re(/\S+/,this,'Cannot be blank');" title="Enter Text to Display for Item here" maxlength="1500" ektdesignns_name="Text" ektdesignns_caption="Text" ektdesignns_nodetype="text" ektdesignns_validation="string-req" ektdesignns_datatype="string" ektdesignns_basetype="text" ektdesignns_schema="&lt;xs:minLength value='1'/&gt;" ektdesignns_validate="re:/\S+/" ektdesignns_invalidmsg="Cannot be blank" /> 
                            </td>
                            <td>
                                <input value="" class="RadETextBox" id="value1" runat="server" onblur="validateChoicesFieldItemValue(this);" title="Enter Item Value here" maxlength="50" ektdesignns_name="value" ektdesignns_caption="value" ektdesignns_nodetype="attribute" ektdesignns_validation="choicesField" /> 
                            </td>
                            <td>
                        ...
                        <tr onclick="design_row_setCurrent(event, this)">
                            <td colspan="5" unselectable="on">
                                ...
                                <img class="design_add_graphic" menutype="button" src="[skinpath]additem.gif" width="9" height="9" border="0" title="Add Item" alt="Add Item" /> 
