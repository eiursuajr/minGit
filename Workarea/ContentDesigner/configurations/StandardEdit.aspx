<%@ Page Language="C#" AutoEventWireup="true" CodeFile="StandardEdit.aspx.cs" Inherits="ContentDesigner_configurations_StandardEdit" %>
<root>
	<modules>
	...
	<tools name="Edit" enabled="true" dockable="false">
		...
		<tool name="Unlink" />
		<tool name="EkLibrary" />
		<% if ((!((Request.QueryString["wiki"] == null)))) { %>
		<tool name="EkAddLinkPage" />
		<% } %>
        <tool name="EkLocalize" />
        <tool name="EkTranslate" />
		<tool separator="true"/>
