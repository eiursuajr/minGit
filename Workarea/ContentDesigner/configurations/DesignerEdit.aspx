<%@ Page Language="C#" AutoEventWireup="true" CodeFile="DesignerEdit.aspx.cs" Inherits="ContentDesigner_configurations_DesignerEdit" %>
<root>
	<modules>
	...
	<tools name="Edit" enabled="true" dockable="false">
		...
		<tool separator="true"/>
		<%--<tool name="EkConditional" /> custom tags in html forms are not processed by display xslt --%>
