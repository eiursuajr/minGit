<%@ Page Language="C#" AutoEventWireup="true" CodeFile="CustomerReports.aspx.cs" Inherits="Commerce_reporting_CustomerReports" %>
<%@ Register Src="../../Widgets/CommerceAdmin/CustomerList.ascx" TagName="KPI" TagPrefix="Ektron" %>
...
<html xmlns="http://www.w3.org/1999/xhtml">
    ...
    <body>
    	...
    	<div class="ektronPageContainer ektronPageInfo">
            ...
            <div class="EktronPersonalization report-container">
                <div class="widget">
                    <div class="header">
                        <div class="buttons">
                            <h4>
            ...
            <div style="position: relative;" >
                <div style="position: absolute; left:-1000px; top: -100px;" >
     	            <asp:linkbutton ToolTip="test" id="Test" runat="server" text="." onclick="Test_Click" visible="true" />
                </div>
            </div>
        </div>
        </form>
