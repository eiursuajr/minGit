...
public partial class Commerce_reporting_PaymentReports : System.Web.UI.Page, IWidgetHost
{
    ...
    {
        string helpScreenAlias = "paymentreports";
        ...
        divTitleBar.InnerHtml = m_refStyle.GetTitleBar(m_refMsg.GetMessage("lbl payment reports"));
