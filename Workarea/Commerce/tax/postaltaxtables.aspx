<%@ Page Language="C#" AutoEventWireup="true" CodeFile="postaltaxtables.aspx.cs" Inherits="Commerce_tax_postaltaxtables" %>
                ...
                <div class="ektronPageInfo">
                        <div class="tabContainerWrapper">
                            <div class="tabContainer">
                                <ul>
                                    <li><a title="Tax Codes" href="#TaxCodes"><%=m_refMsg.GetMessage("lbl Tax Codes")%></a></li>
                                    <li><a title="Tax Rates" href="#TaxRates"><%=m_refMsg.GetMessage("lbl tax rates")%></a></li>
                                </ul>
                                <div id="TaxCodes">
