<%@ Page Language="C#" AutoEventWireup="true" CodeFile="countrytaxtables.aspx.cs" Inherits="Commerce_tax_countrytaxtables" %>
<!DOCTYPE html PUBLIC "-//W3C//DTD XHTML 1.0 Transitional//EN" "http://www.w3.org/TR/xhtml1/DTD/xhtml1-transitional.dtd">
<html xmlns="http://www.w3.org/1999/xhtml">
<head runat="server">
    <meta content="text/html; charset=UTF-8" http-equiv="content-type" />
    <title>Country Tax Tables</title>
			    ...
			    ***********************************************/
			    ...
			    $ektron().ready(function () {
			        if (navigator.appName == "Microsoft Internet Explorer") {
			            $ektron("#btnSearch").attr("style", "text-indent: 7px;");
			        }
			    });
                ...
                <div class="ektronPageInfo">
                    <div class="tabContainerWrapper">
                        <div class="tabContainer">
                            <ul>
                                <li><a title="Tax Region" href="#TaxRegion"><%=this.GetMessage("lbl Tax Region")%></a></li>
                                <li><a title="Tax Rates" href="#TaxRates"><%=this.GetMessage("lbl tax rates")%></a></li>
                            </ul>
                            <div id="TaxRegion">
                                <table id="tblmain" runat="server" class="ektronForm">
                                    <tr>
                                        <td class="label">
                                            <asp:Literal ID="ltr_name" runat="server" />:</td>
                                        <td class="value">
                                    ...
                                    <tr id="tr_id" runat="server">
                                        ...
                                        <td class="value">
                                            <asp:Label ToolTip="ID" ID="lbl_id" runat="server" />
                                        </td>
                                    </tr>
                                    <tr>
                                        <td class="label">
                                            <asp:Literal ID="ltr_enabled" runat="server" />:</td>
                                        <td class="value">
                                            <asp:CheckBox ToolTip="Enable/Disable Region" ID="chk_enabled" runat="server" />
                                        </td>
                                    </tr>
                                    <tr>
                                        <td class="label">
                                            <asp:Literal ID="ltr_long" runat="server" />:</td>
                                        <td class="value">
                                            <asp:TextBox ID="txt_long" runat="server" Columns="50" MaxLength="25" />
                                        </td>
                                    </tr>
                                    <tr runat="server" id="tr_numIso">
                                        <td class="label">
                                            <asp:Literal ID="ltr_numeric" runat="server" />:</td>
                                        <td class="value">
                                            <asp:TextBox ID="txt_numeric" runat="server" Columns="50" MaxLength="25" />
                                        </td>
                                    </tr>
                                    <tr>
                                        <td class="label">
                                            <asp:Literal ID="ltr_short" runat="server" />:</td>
                                        <td class="value">
                                            <asp:TextBox ID="txt_short" runat="server" Columns="50" MaxLength="25" />
                                        </td>
                                    </tr>
                                </table>
                            </div>
