function Menu(label) {
    ...
    this.menuItemBgColor = "#6699ff";
    this.menuLiteBgColor = "#ffffff";
    this.menuBorderBgColor = "#777777";
    this.menuHiliteBgColor = "#000084";
    this.menuContainerBgColor = "#6699ff";
    this.childMenuIcon = "./workarea/images/application/arrows.gif";
    this.childMenuIconHilite = "./workarea/images/application/arrows2.gif";
        ...
        for (var i=0; i<menu.items.length; i++) {
            ...
            if (tmpItem != "") {
				if (typeof tmpItem == "string") {
					tmpItem = tmpItem.toUpperCase();
				}
			}
            if (item.label) {
                item = item.label;
                childMenu = true;
            } else if (item.indexOf(".gif") != -1 && tmpItem.indexOf("<IMG") == -1) {
            ...
            var dTag    = '<DIV  class="menuItemText" ID="menuItem'+ countItems +'" STYLE="cursor:pointer;position:absolute;left:0;top:'+ (i * proto.menuItemHeight) +';'+ itemProps +'">';
...
function onMenuItemOver(e, l, a) {
    ...
    if (document.layers) {
        ...
        l.focusItem.style.zIndex = l.focusItem.style.zIndex + 1;
        l.zIndex = 1;
        l.Menu.hideChildMenu(l);
    } else if (document.getElementById){   
		if (l.Menu != null) {
