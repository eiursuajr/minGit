...
var StringUtil =
{
	...
	//
	// name: capitalize
	// desc: Given an input string, this function capitalizes it.
	//
	
	capitalize: function( s )
	{
		var word  = new String( s );
		var rest  = "";
		var first = "";
		 
		if( word.length ) {
			var first = new String( s.charAt( 0 ) ).toUpperCase();
			if( word.length > 0 ) {
				rest = new String( word.substring( 1 ) ).toLowerCase();
			}
		}
