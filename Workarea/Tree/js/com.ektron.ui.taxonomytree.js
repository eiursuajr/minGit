...
var TreeDisplayUtil =
{
    ...
    renderSelf: function(tree, container)
    {
        ...
        var strOnMouseOver = "";
        strOnMouseOut = "";
        if (taxonomytreemode != "editor" || taxonomytreemenu)
        {
            strOnMouseOver = " onmouseover='showWammFloatMenuForMenuNode(true, false, event, " + tree.node.id + ", this);' ";
        ...
        {
            buffer += "<img treeid='" + tree.node.id + "' onclick='TreeDisplayUtil.toggleTree(" + tree.node.id + ")' " + strClass + " " + strOnMouseOut + " id='I" + tree.node.id + "' src='" + src + "'>";
        }
        ...
        else if (taxonomytreemode == "editor" && __TaxonomyOverrideId > 0)
        {
            ...
            buffer += "<input type=\"hidden\" id=\"chkTree_T" + tree.node.id + "\" name=\"chkTree_T" + tree.node.id + "\" value=\"" + chkvalue + "\"/><input type=\"checkbox\" id=\"chkTree\" name=\"chkTree\" value=\"" + tree.node.id + "\" onclick=\"javascript:selecttaxonomy(this);\"" + chkcheckedoption + "/>";
            buffer += buffer1 + tree.node.name + " (<span id=\"TIC" + tree.node.id + "\">" + tree.node.data.count + "</span>)</a>";
        }
        else
        {
            buffer += buffer1 + tree.node.name + " (<span id=\"TIC" + tree.node.id + "\">" + tree.node.data.count + "</span>)</a>";
    ...
    createNodeHTML: function(tree)
    {
        ...
        if (taxonomytreemode == "editor")
        {
            ...
            else if (fetchdisabletaxonomyid(tree.node.id))
            {
             ...
             if (tree.node.data.visible == "true")
                buffer += "<input type=\"hidden\" id=\"chkTree_T" + tree.node.id + "\" name=\"chkTree_T" + tree.node.id + "\" value=\"" + chkvalue + "\"/><input type=\"checkbox\" id=\"chkTree\" name=\"chkTree\" value=\"" + tree.node.id + "\" onclick=\"javascript:selecttaxonomy(this);\"" + chkcheckedoption + "/>";
        }
        ...
        if (tree.node.data.visible == "false")
            buffer += "<a class='linkStyleDisabled' href='#'  id='" + tree.node.id + "' onclick='TreeDisplayUtil.displayContents(" + tree.node.id + ", this);return false;'>"
        else
            buffer += "<a class='linkStyle' href='#'  id='" + tree.node.id + "' onclick='TreeDisplayUtil.displayContents(" + tree.node.id + ", this);return false;'>"
        buffer += tree.node.name + " (<span id=\"TIC" + tree.node.id + "\">" + tree.node.data.count + "</span>)</a>";
        buffer += "</span>";
        return buffer;
    }
}
