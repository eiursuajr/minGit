<%@ Control Language="C#" AutoEventWireup="true" CodeFile="viewtaxonomy.ascx.cs"
...
<div id="searchpanel" class="ektronPageContainer ektronPageInfo">
    <div class="tabContainerWrapper">
        <div class="tabContainer">
            <ul>
                <li>
                    <a title="<%=_MessageHelper.GetMessage("generic items")%>" href="#dvItems">
                ...
                <li>
                    <a title="<%=_MessageHelper.GetMessage("lbl Custom Properties Data")%>" href="#dvMetadata" id="customPropertiesTabButton">
            ...
            <div id="dvItems">
                ...
                <div class="ui-helper-clearfix" id="removeItemsWrapper" runat="server" visible="false" style="margin-bottom: .5em;">
                    ...
                    <asp:LinkButton ToolTip="Second Page" runat="server" CssClass="pageLinks" ID="PreviousPage" Text="[Previous Page]"
                ...
                <table class="ektronGrid">
                    ...
                    <tr>
                        ...
                        <td class="readOnlyValue">
                            ...
                            <span title="<%= taxonomy_image.Text%>"><asp:literal id="taxonomy_image" runat="server" /></span>
                    ...
                    <tr id="tr_taxsynch" runat="server">
                       <td class="label"><%=_MessageHelper.GetMessage("lbl tax synch")%></td>
                       <td class="readOnlyValue">
                            <asp:Literal ID="ltrTaxSynch" runat="server" />
                            <div class="ektronCaption"><%=_MessageHelper.GetMessage("lbl tax synch msg")%></div>
                       </td>
                    </tr>
                    <tr>
                ...
                <table id="customProperties" class="ektronGrid">
                    <tbody>
                        <tr class="title-header">
                            <td style="width: 40%;"><%=_MessageHelper.GetMessage("lbl title")%><asp:Label ID="lblTitleHeader" runat="server"></asp:Label></td>
                            <td style="width: 20%;"><%=_MessageHelper.GetMessage("data type")%><asp:Label ID="lblDataTypeHeader" runat="server"></asp:Label></td>
                            <td style="width: 30%;"><%=_MessageHelper.GetMessage("lbl taxonomy custom prop value")%><asp:Label ID="lblValueHeader" runat="server"></asp:Label></td>
                        </tr>
                    </tbody>
                </table>
                <div id="customPropertyPaging">
                    <p class="pageLinks">
                        <%=_MessageHelper.GetMessage("lbl pagecontrol page")%> <span id="customPropertyPage" class="pageLinks"></span>  <%=_MessageHelper.GetMessage("lbl pagecontrol of")%>  <span class="pageLinks" id="customPropertyTotalPages"></span>
                    </p>
                    <a href="#" class="pageLinks" rel="Start" title="First Page">[<%=_MessageHelper.GetMessage("lbl first page")%>]</a>
                    <a href="#" class="pageLinks" rel="Prev" title="Previous Page">[<%=_MessageHelper.GetMessage("lbl previous page")%>]</a>
                    <a href="#" class="pageLinks" rel="Next" title="Next Page">[<%=_MessageHelper.GetMessage("lbl next page")%>]</a>
                    <a href="#" class="pageLinks" rel="End" title="Last Page">[<%=_MessageHelper.GetMessage("lbl last page")%>]</a>
                </div>
            </div>
        </div>
    </div>
