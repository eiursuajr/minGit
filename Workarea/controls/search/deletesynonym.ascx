<%@ Control Language="C#" AutoEventWireup="true" CodeFile="deletesynonym.ascx.cs" Inherits="Workarea_search_deletesynonym" %>
...
<asp:Literal ID="synonymOutput" runat="server" />