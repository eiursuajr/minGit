<%@ Page Language="C#" AutoEventWireup="true" CodeFile="LocaleTaxonomy.aspx.cs" Inherits="Workarea_LocaleTaxonomy" %>

<%@ Reference Control="../controls/localetaxonomy/addLocaleTaxonomy.ascx" %>
<%@ Reference Control="../controls/localetaxonomy/viewLocaleTaxonomy.ascx" %>
<%@ Reference Control="../controls/localetaxonomy/editLocaleTaxonomy.ascx" %>
<%@ Reference Control="../controls/localetaxonomy/assignLocaleTaxonomy.ascx" %>
<%@ Register TagPrefix="uxEktron" TagName="Tree" Src="LocaleTaxonomyTree.ascx" %>

<!DOCTYPE html PUBLIC "-//W3C//DTD XHTML 1.0 Transitional//EN" "http://www.w3.org/TR/xhtml1/DTD/xhtml1-transitional.dtd">

<html xmlns="http://www.w3.org/1999/xhtml">
<head id="Head1" runat="server">
    <title>Locale Taxonomy</title>
    ...
    <script type="text/javascript">
        ...
        function defaultLoadLanguage(num) {
            ...
            document.forms[0].action = "LocaleTaxonomy.aspx?LangType=" + num;
    ...
    <form id="form1" runat="server">    
        <div id="div_taxonomylist" visible="false" runat="server">        
            ...
            <div id="tr_taxonomylist" class="ektronPageContainer" runat="server">            
                <uxEktron:Tree ID="taxonomyTree" runat="server" AllowSelectMultiple="false" />
