<%@ Page Language="C#" AutoEventWireup="true" CodeFile="Taxonomy.Tree.B.aspx.cs" Inherits="Taxonomy_Tree_B_aspx" %>
...
<asp:MultiView ID="mvTaxonomyJs" runat="server">
    <asp:View ID="vwShow" runat="server">
            ...
            var g_isIE9Flag = false;

            function IsBrowserIE(){
	            if (!g_isIeInit) {
		            var ua = window.navigator.userAgent.toLowerCase();
		            g_isIeFlag = (ua.indexOf('msie') > -1) && (!(ua.indexOf('opera') > -1));
                    g_isIE9Flag = (parseFloat(window.navigator.appVersion.split("MSIE")[1]) >= 9);
		            g_isIeInit = true;
	            }
	            return (g_isIeFlag);
            }
