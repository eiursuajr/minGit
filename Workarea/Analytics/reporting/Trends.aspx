<%@ Page Language="C#" AutoEventWireup="true" CodeFile="Trends.aspx.cs" Inherits="Analytics_Reporting_Trends" %>
<%@ Register TagPrefix="analytics" TagName="Toolbar" Src="../controls/AnalyticsToolbar.ascx" %>
<%@ Register TagPrefix="analytics" TagName="Trend" Src="Trend.ascx" %>
...
<style type="text/css" >
    ...
    .EktronPersonalization .workareaReportFixedArea { min-width: 630px !important; min-height: 200px !important;}
...
<body>
    ...
    <div class="widget" style="position: static; top: 0px !important; left: 0px !important; display: block !important; border: 0; margin: 0;">
        <div class="ektronPageContainer">
            <div class="ektronTitlebar" style="min-width: 625px;">
                <table>
